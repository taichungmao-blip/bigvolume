...
def find_bottom_consolidation_stocks():
    ...
    for ticker in tickers:
        try:
            ...
            # 條件 D: 確保最後一個交易日依然保持絕對靜止 (不可大於近期極低均量的 1.5 倍)
            ...
            matched_stocks.append(
                ...
                f"收盤價: `{current_close:.2f}` | 盤整均量: `{int(recent_mean_vol / 1000)}` 張 | 本益比: `{pe_str}`\n"
